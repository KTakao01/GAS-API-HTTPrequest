...
function updateTrigger() {
          ...
          if (referredId.indexOf("認証") == -1 && referId.indexOf("認証") != -1) {
            ...
            if (referredAuth == referId) {
              ...
              if (referValueUserId != "" && referredKey1array[col] == referKeyUserId) {
                console.log(colLog + "列は" + referredKey1array[col] + "のkeyです。\n" + referredValueRowNumber + "行" + colLog + "列のセルがuser_idキーですので" + referKeyUserId + "の書き込み処理を行う予定です。")
              ...
              //認証APIのaccess_tokenバリューが存在していて、参照APIのキー配列に認証APIのaccess_tokenキーが一致するところで、認証APIのaccess_tokenバリューを渡す
                ...
                console.log( colLog + "列は" + referredKey1array[col] + "のkeyです。\n" + referredValueRowNumber + "行" + colLog + "列のセルがaccess_tokenキーですので" + referKeyAccessToken + "の書き込み処理を行う予定です。");
                //console.log(count)
                //console.log(1)
 ...
 console.log(colLog + "列は" + referredKey1array[col] + "のkeyです。\n" + referredValueRowNumber + "行" + colLog + "列のセルがaccess_tokenでもuser_idキーでもありませんので書き込み処理を行いません") 
