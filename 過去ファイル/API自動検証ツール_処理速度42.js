...
function referenceAuthtest9() {
  ...
  for (var m = startH; m+2 < numHI; m = m + 2) {
    //k=0のときk+1=1、k=2のときk+1=3,k=4のときk+1=5→keyの行に対応
    //k=0のときk+2=2、k=2のときk+2=4,k=4のときk+2=6→valueの行に対応
    ...
    for (var n = 0; n < numJ -2; n += 2) {
      ...
      console.log(referIdArray)
      console.log(referredId1Array)
  ...
  sht.getRange(startI + 1, startJ + 1, referredValueRowNumber - 1, numJ).setValues(lineArray);
}
